...
python ../generator/generate.py ../docker/Dockerfile.jupyter-py36-cpu tensorflow keras pytorch python==3.6 onnx jupyterlab
...
python ../generator/generate.py ../docker/Dockerfile.all-py36-cu80 tensorflow keras pytorch python==3.6 onnx --cuda-ver 8.0 --cudnn-ver 6
python ../generator/generate.py ../docker/Dockerfile.jupyter-py36-cu80 tensorflow keras pytorch python==3.6 onnx jupyterlab --cuda-ver 8.0 --cudnn-ver 6
...
python ../generator/generate.py ../docker/Dockerfile.jupyter-py36-cu90 tensorflow keras pytorch python==3.6 onnx jupyterlab --cuda-ver 9.0 --cudnn-ver 7
